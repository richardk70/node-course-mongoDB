...
describe('GET /users/me', () => {
  ...
  it('should return a 401 if not authenticated', (done) => {
    request(app)
      .get('/users/me')
      // expect 401, // body should be an empty object
      .expect(401)
      .expect( (res) => {
...
describe('POST /users', () => {
  ...
  it('should NOT create user if email already in use', (done) => {
    var dupeEmail = 'dick@example.com'
    request(app)
      .post('/users')
      .send({dupeEmail})
      .expect(400)
...
=======
    it('should update the todo', (done) => {
        ...
        it('should clear completedAt when completed is false', (done) => {
          ...
          var hexID = todos[1]._id.toHexString();
          var text = 'this is the new text, updated';
          request(app)
          .patch(`/todos/${hexID}`)
          .send({
            text: text,
